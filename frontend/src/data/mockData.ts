...
export const INITIAL_FOOD_ITEMS: FoodItem[] = [
  // Hot Drinks
  {
    ...
    price: 180,
    description:
      "Double shot of organic espresso with steamed oat milk and fresh vanilla bean syrup.",
    image:
  ...
  },
  {
    ...
    price: 220,
    description:
      "Stone-ground Uji matcha whisked with creamy almond milk and a touch of organic agave.",
    image:
  ...
  },
  {
    ...
    price: 120,
    description:
      "Traditional slow-brewed milk tea infused with fresh ginger and crushed green cardamom.",
    image:
  ...
  // Quick Bites
  {
    ...
    price: 260,
    description:
      "Crispy golden fries tossed in white truffle oil, grated parmesan, and fresh rosemary.",
    image:
  ...
  },
  {
    ...
    price: 340,
    description:
      "Tortilla chips baked with cheddar, black beans, jalapeños, fresh salsa, and sour cream.",
    image:
  ...
  },
  {
    ...
    price: 380,
    description:
      "Three mini brioche buns filled with buttermilk fried chicken, spicy mayo, and pickles.",
    image:
      "https://images.unsplash.com/photo-1550317138-10000687a72b?auto=format&fit=crop&q=80&w=400",
    category: "quick-bites",
    isVeg: false,
    isAvailable: true,
  },
  ...
  // Mains
  {
    ...
    price: 320,
    description:
      "Artisanal sourdough topped with smashed Hass avocado, cherry tomatoes, and a soft-poached egg.",
    image:
  ...
  },
  {
    ...
    price: 450,
    description:
      "Smoked angus beef patty with melted provolone, grilled onions, and house barbecue sauce.",
    image:
  ...
  },
  {
    ...
    price: 390,
    description:
      "Penne pasta tossed in rich basil pine-nut pesto, fresh cream, roasted garlic, and pine nuts.",
    image:
  ...
  },
  {
    ...
    price: 290,
    description:
      "Charcoal-grilled paneer, bell peppers, mint chutney, and pickled onions wrapped in a soft paratha.",
    image:
      "https://images.unsplash.com/photo-1628831291075-35e0c5d599ee?auto=format&fit=crop&q=80&w=400",
    category: "mains",
    isVeg: true,
    isAvailable: true,
  },
  ...
  // Desserts
  {
    ...
    price: 280,
    description:
      "Rich and creamy classic baked cheesecake served with fresh wild berry compote.",
    image:
      "https://images.unsplash.com/photo-1524351199679-46cddf530c04?auto=format&fit=crop&q=80&w=400",
    category: "desserts",
    isVeg: true,
    isAvailable: true,
  },
  {
    ...
    price: 240,
    description:
      "Warm chocolate cake with a molten lava center, served with premium vanilla bean gelato.",
    image:
  ...
  },
  {
    ...
    price: 290,
    description:
      "Layers of espresso-soaked ladyfingers and whipped mascarpone cream, dusted with dark cocoa.",
    image:
  ...
  // Added Items
  {
    ...
    price: 190,
    description:
      "Steamed almond milk infused with organic turmeric root, ginger, cinnamon, and black pepper, sweetened with maple syrup.",
    image:
  ...
  {
    id: "qb-4",
    name: "Avocado Crostini & Pomegranate",
    price: 220,
    description:
      "Toasted baguette slices with smashed avocado, pomegranate pearls, feta crumble, and balsamic reduction.",
    image:
  ...
  },
  {
    ...
    price: 480,
    description:
      "Perfectly seared salmon fillet served over tri-color quinoa, baby spinach, edamame, avocado, and sesame-ginger dressing.",
    image:
  ...
  {
    id: "d-4",
    name: "Warm Apple Berry Crumble",
    price: 260,
    description:
      "Stewed organic apples and mixed berries topped with a crunchy oat and almond crumble, served with vanilla custard.",
    image:
      "https://images.unsplash.com/photo-1508737804141-4c3b688e2546?auto=format&fit=crop&q=80&w=400",
    category: "desserts",
    isVeg: true,
    isAvailable: true,
  },
